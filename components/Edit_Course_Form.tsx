...
import { revalidatePage, updateCourse } from '@/server_actions';
     ...
     <FormField
      ...
      render={({ field }) => (
       <FormItem>
        ...
        <FormControl>
         <Input type='text' placeholder={coursename || ''} {...form.register('name')} className='pl-10' {...field} />
        </FormControl>
        <FormMessage />
       </FormItem>
      )}
     ...
     <FormField
      ...
      render={({ field }) => (
       <FormItem>
        ...
        <FormControl>
         <Input type='text' placeholder={coursetrainer || ''} {...form.register('name')} className='pl-10' {...field} />
        </FormControl>
        <FormMessage />
       </FormItem>
      )}
